...
export default function Hero() {
  return (
    <div className="relative bg-linear-to-br from-slate-50 to-teal-50">
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center py-24 px-6 md:px-12">
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <a href="/signup" className="px-6 py-3 bg-linear-to-r from-teal-600 to-emerald-600 text-white font-semibold rounded-md shadow hover:from-teal-700 hover:to-emerald-700 transition-all">
            Get Started
          </a>
        </div>
