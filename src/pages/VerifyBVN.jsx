    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-teal-50 p-6">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow border-t-4 border-teal-600">
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          ...
          <div>
            <button type="submit" className="w-full px-4 py-2 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded hover:from-teal-700 hover:to-emerald-700 font-semibold">Verify BVN</button>
          </div>
